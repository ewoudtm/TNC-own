...
# product_negotations
prod_neg1 = ProdNeg.create!(
  single_bids: [],
  active: true,
  product_id: product1.id,
  user_id: user2.id
)
prod_neg2 = ProdNeg.create!(
  single_bids: [],
  active: true,
  product_id: product2.id,
  user_id: user1.id
)
prod_neg3 = ProdNeg.create!(
  single_bids: [],
  active: true,
  product_id: product3.id,
  user_id: user2.id
)
prod_neg4 = ProdNeg.create!(
  single_bids: [],
  active: true,
  product_id: product1.id,
  user_id: user3.id
)
prod_neg5 = ProdNeg.create!(
  single_bids: [],
  active: true,
  product_id: product6.id,
  user_id: user2.id
)
prod_neg6 = ProdNeg.create!(
  single_bids: [],
  active: true,
  product_id: product8.id,
  user_id: user1.id
)
prod_neg7 = ProdNeg.create!(
  single_bids: [],
  active: false,
  product_id: product2.id,
  user_id: user3.id
...
single_bid4 = SingleBid.create!(
  prod_neg_id: prod_neg2.id,
  price: 75,
  accepted: false,
  user_id: user1.id,
)
single_bid5 = SingleBid.create!(
  prod_neg_id: prod_neg3.id,
  price: 40,
  accepted: false,
  user_id: user3.id,
)
